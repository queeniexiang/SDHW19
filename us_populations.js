...
var sample_data = '[{"females": 1652000, "country": "United States", "age": 0, "males": 1780000, "year": 1980, "total": 3432000}, {"females": 1624000, "country": "United States", "age": 1, "males": 1734000, "year": 1980, "total": 3358000}, {"females": 1605000, "country": "United States", "age": 2, "males": 1703000, "year": 1980, "total": 3307000}]';
...
var percent_gender = function() {
    var total = 0
    var females = 0;
    var males = 0;


    var female_total = data.map(function(n) {return n['females']});
    var male_total = data.map(function(n) {return n['males']});
    var total_total = data.map(function(n) {return n['total']});


    females = female_total.reduce(function(females, y) {return females+y});
    males = male_total.reduce(function(males, y) {return males+y});
    total = total_total.reduce(function(total, y) {return total+y});

    console.log("Female total:");
    console.log(females);
    ...
    console.log("percent female:");
    console.log(females);
    console.log("percent male:");
    console.log(males);
...
var num_minors = function() {
    ...
    var minor_count = data.filter(function(n) {return (n['age'] < 18)});
    minor_count = minor_count.map(function(n) {return n['total']});

    total = minor_count.reduce(function(total, y) {return total+y});

    console.log("total minors:");
    console.log(total);
    return total;
}
...
var median_age = function() {
    var total = 0;

    var total_count = data.map(function(n) {return n['total']});
    total = total_count.reduce(function(total, y) {return total+y});

    var median_number = total / 2;

    for (x in data) {
	median_number -= data[x]['total'];
...
var gen = percent_gender();
var ul = document.createElement('ul');
var item = document.createElement('li');
item.appendChild(document.createTextNode("female percentage: " + gen[0]));
ul.appendChild(item);
item = document.createElement('li');
item.appendChild(document.createTextNode("male percentage: " + gen[1]));
ul.appendChild(item);
item = document.createElement('li');
item.appendChild(document.createTextNode("median age: " + median_age()));
ul.appendChild(item);
